...
| `--convert_dotd` | boolean | `false` | Convert Bruker `.d` files to mzML before analysis. |
...
| `--quantums` | boolean | `false` | Enable QuantUMS quantification algorithms (DIA-NN `--direct-quant`). |
